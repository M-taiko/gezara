...
@section('content')
<div class="row mb-3">
    <div class="col-xl-3"><div class="card"><div class="card-body text-center"><h4>{{ number_format($totalAmount, 2) }}</h4><small class="text-muted">إجمالي الصكوك (ج.م)</small></div></div></div>
    <div class="col-xl-3"><div class="card"><div class="card-body text-center"><h4 class="text-success">{{ number_format($paidAmount, 2) }}</h4><small class="text-muted">المدفوع (ج.م)</small></div></div></div>
    <div class="col-xl-3"><div class="card"><div class="card-body text-center"><h4 class="text-danger">{{ number_format($remainingAmount, 2) }}</h4><small class="text-muted">المتبقي (ج.م)</small></div></div></div>
    <div class="col-xl-3"><div class="card"><div class="card-body text-center"><h4>{{ $customer->contracts->count() }}</h4><small class="text-muted">عدد الصكوك</small></div></div></div>
</div>
