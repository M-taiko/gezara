                    ...
                    <td class="px-5 py-4">
                        <div class="flex items-center justify-center gap-1.5">
                            ...
                            <a href="{{ route('udhiya.contracts.edit', $contract) }}"
                               class="inline-flex items-center justify-center w-8 h-8 rounded-lg bg-amber-50 text-amber-600 hover:bg-amber-500 hover:text-white transition-colors text-xs"
                               title="تعديل">
                            ...
                            @endif
                            {{-- Delete --}}
                            <form action="{{ route('udhiya.contracts.destroy', $contract) }}" method="POST" style="display: inline;"
                                  onsubmit="return confirm('هل أنت متأكد من حذف هذا الصك؟')">
                                @csrf
                                @method('DELETE')
                                <button type="submit"
                                        class="inline-flex items-center justify-center w-8 h-8 rounded-lg bg-rose-50 text-rose-600 hover:bg-rose-500 hover:text-white transition-colors text-xs"
                                        title="حذف الصك">
