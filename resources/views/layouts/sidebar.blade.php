						...
						<div class="tab-pane active " id="side1">
							<div class="list d-flex align-items-center border-bottom p-3">
								...
								<a class="wrapper w-100 mr-3" href="#" >
									<p class="mb-0 d-flex ">
										<b>تم إنشاء موقع جديد</b>
									</p>
									<div class="d-flex justify-content-between align-items-center">
										<div class="d-flex align-items-center">
											<i class="mdi mdi-clock text-muted ml-1"></i>
											<small class="text-muted ml-auto">منذ ٣٠ دقيقة</small>
											<p class="mb-0"></p>
										</div>
									</div>
								</a>
							...
							<div class="list d-flex align-items-center border-bottom p-3">
								...
								<a class="wrapper w-100 mr-3" href="#" >
									<p class="mb-0 d-flex ">
										<b>التحضير للمشروع القادم</b>
									</p>
									<div class="d-flex justify-content-between align-items-center">
										<div class="d-flex align-items-center">
											<i class="mdi mdi-clock text-muted ml-1"></i>
											<small class="text-muted ml-auto">منذ ساعتين</small>
											<p class="mb-0"></p>
										</div>
									</div>
								</a>
							...
							<div class="list d-flex align-items-center border-bottom p-3">
								...
								<a class="wrapper w-100 mr-3" href="#" >
									<p class="mb-0 d-flex ">
										<b>تحديد موعد النقاش</b>
									</p>
									<div class="d-flex justify-content-between align-items-center">
										<div class="d-flex align-items-center">
											<i class="mdi mdi-clock text-muted ml-1"></i>
											<small class="text-muted ml-auto">منذ ٣ ساعات</small>
											<p class="mb-0"></p>
										</div>
									</div>
								</a>
							...
							<div class="list d-flex align-items-center border-bottom p-3">
								...
								<a class="wrapper w-100 mr-3" href="#" >
									<p class="mb-0 d-flex ">
										<b>اجتماع الساعة ٣:٠٠ م</b>
									</p>
									<div class="d-flex justify-content-between align-items-center">
										<div class="d-flex align-items-center">
											<i class="mdi mdi-clock text-muted ml-1"></i>
											<small class="text-muted ml-auto">منذ ٤ ساعات</small>
											<p class="mb-0"></p>
										</div>
									</div>
								</a>
							...
							<div class="list d-flex align-items-center border-bottom p-3">
								...
								<a class="wrapper w-100 mr-3" href="#" >
									<p class="mb-0 d-flex ">
										<b>التحضير للعرض التقديمي</b>
									</p>
									<div class="d-flex justify-content-between align-items-center">
										<div class="d-flex align-items-center">
											<i class="mdi mdi-clock text-muted ml-1"></i>
											<small class="text-muted ml-auto">منذ يوم</small>
											<p class="mb-0"></p>
										</div>
									</div>
								</a>
							...
							<div class="list d-flex align-items-center border-bottom p-3">
								...
								<a class="wrapper w-100 mr-3" href="#" >
									...
									<div class="d-flex justify-content-between align-items-center">
										<div class="d-flex align-items-center">
											<i class="mdi mdi-clock text-muted ml-1"></i>
											<small class="text-muted ml-auto">منذ ٤٥ دقيقة</small>
											<p class="mb-0"></p>
										</div>
									</div>
								</a>
							...
							<div class="list d-flex align-items-center p-3">
								...
								<a class="wrapper w-100 mr-3" href="#" >
									...
									<div class="d-flex justify-content-between align-items-center">
										<div class="d-flex align-items-center">
											<i class="mdi mdi-clock text-muted ml-1"></i>
											<small class="text-muted ml-auto">منذ يومين</small>
											<p class="mb-0"></p>
										</div>
									</div>
								</a>
						...
						<div class="tab-pane  " id="side2">
							<div class="list-group list-group-flush ">
								<div class="list-group-item d-flex  align-items-center">
									...
									<div>
										<strong>Madeleine</strong> أهلاً! أنا متاح الآن
								...
								<div class="list-group-item d-flex  align-items-center">
									...
									<div>
										<strong>Anthony</strong> إطلاق منتج جديد
										<div class="small text-muted">
											منذ ٥ ساعات
										</div>
									</div>
								...
								<div class="list-group-item d-flex  align-items-center">
									...
									<div>
										<strong>Olivia</strong> جدول زمني جديد
										<div class="small text-muted">
											منذ ٤٥ دقيقة
										</div>
									</div>
								...
								<div class="list-group-item d-flex  align-items-center">
									...
									<div>
										<strong>Olivia</strong> أهلاً! أنا متاح الآن
										<div class="small text-muted">
											منذ ١٢ دقيقة
										</div>
									</div>
